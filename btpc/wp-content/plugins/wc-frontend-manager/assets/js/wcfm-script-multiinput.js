jQuery(document).ready(function($) {
    ...
    multi_input_holder.children('.multi_input_block').each(function() {
      ...
      $(this).prepend('<span class="fa fa-arrows-alt wcfm_multiblock_sortable img_tip" data-tip="'+wcfm_dashboard_messages.wcfm_multiblick_sortable_help+'"></span><div class="wcfm_clearfix"></div>');
    });
