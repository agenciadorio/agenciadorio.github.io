...
/*
Template Name: Three rooms list
*/
...
get_header(); ?> 
		...
		<div class="container rooms-three-columns-list">
					...
					<!-- BEGIN ROOM WRAP -->
					<div class="rooms-list-item-wrap <?php if ($count%3==0) { echo 'list-three-last'; } ?>">
						...
						<div class="rooms-list-content-wrap">
							...
							<div class="rooms-list-content"><?php nation_excerpt(20); ?></div>
						</div>
