...
if ( ! function_exists( 'electro_navbar_search' ) ) {
	...
	function electro_navbar_search() {
		electro_get_template( 'sections/navbar-search2.php' );
	}
}
	...
	function electro_navbar_compare() {
		if( function_exists( 'electro_get_compare_page_url' ) ) {
			...
			<ul class="navbar-compare nav navbar-nav pull-right flip">
				<li class="nav-item">
				 <div class="vc_empty_space"  style="height: 14px" ><span class="vc_empty_space_inner"></span></div> <a href="/minha-conta" class="dcontexto"> <img class="size-full wp-image-1238 alignright" src="https://www.bestpecas.com.br/wp-content/uploads/2018/04/icon.png" alt="" width="25" height="23" /> </small> </b> </font> <span><small> Entre ou cadastre-se </small>  </span> </a>
				</li>
			</ul>
			<?php
		}
