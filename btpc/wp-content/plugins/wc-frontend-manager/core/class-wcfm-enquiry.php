	...
	function wcfm_enquiry_button() {
		...
		if( apply_filters( 'wcfm_is_pref_enquiry_button', true ) ) {
			...
			<div class="wcfm_ele_wrapper wcfm_catalog_enquiry_button_wrapper">
				...
				<a href="#" class="wcfm_catalog_enquiry" style="<?php echo $button_style; ?>"><span class="fa fa-question-circle-o"></span>&nbsp;&nbsp;<span class="add_enquiry_label"><?php _e( 'Ask a Question', 'wc-frontend-manager' ); ?></span></a>
				<?php if( $base_color ) { ?>
