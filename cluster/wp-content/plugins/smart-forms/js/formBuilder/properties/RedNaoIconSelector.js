...
var RedNaoIconSelector = /** @class */ (function () {
    function RedNaoIconSelector() {
        this.$Dialog = null;
        this.$Select = null;
    }
    Object.defineProperty(RedNaoIconSelector, "Current", {
        get: function () {
    ...
    RedNaoIconSelector.prototype.InitializeDialog = function () {
        this.$Dialog = rnJQuery('<div class="modal fade"  tabindex="-1">' +
    ...
    ;
    return RedNaoIconSelector;
}());
exports.RedNaoIconSelector = RedNaoIconSelector;
//# sourceMappingURL=RedNaoIconSelector.js.map