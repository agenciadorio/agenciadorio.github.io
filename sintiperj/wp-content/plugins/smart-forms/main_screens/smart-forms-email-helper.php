...
wp_enqueue_script('smart-forms-email-helper',SMART_FORMS_DIR_URL.'js/main_screens/smart-forms-email-helper.js','isolated-slider');
...
<script type="application/javascript"  language="JavaScript">
    var formId=<?php echo $_GET["form_id"]?> ;
    var emailIndex=<?php echo $_GET["email_index"] ?>;
