										...
										if ( 'disabled' == $disable_woo_shipping ) {
											...
											if( version_compare( DOKAN_PRO_PLUGIN_VERSION, '2.8.0', '>' ) ) {
												echo '<div class="wcfm_dokan_non_regular_shipping">';
													printf( '<p>%s<br /></p>', __( 'A shipping zone is a geographic region where a certain set of shipping methods are offered. WooCommerce will match a customer to a single zone using their shipping address and present the shipping methods within that zone to them.', 'dokan' ) );
