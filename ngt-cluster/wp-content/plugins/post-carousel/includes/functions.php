...
class SP_Post_Carousel_Functions {
	 ...
	 */
	function admin_menu() {
		add_submenu_page( 'edit.php?post_type=sp_pc_shortcodes', __( 'Post Carousel Help', 'post-carousel' ), __( 'Help', 'post-carousel' ), 'manage_options', 'help', array( $this, 'help_page_callback'
		) );
	}
	...
	public function help_page_callback() {
        ...
        <div class="wrap about-wrap sp-pc-help">
            ...
            <p class="about-text"><?php _e( 'Thank you for installing Post Carousel! You\'re now running the most popular Post Carousel plugin.
This video will help you get started with the plugin.', 'post-carousel' ); ?></p>
            ...
            <div class="feature-section three-col">
                <div class="col">
                    <div class="sp-pc-feature sp-pc-text-center">
                        ...
                        <a href="https://wordpress.org/support/plugin/post-carousel" target="_blank" class="button button-primary">Contact Support</a>
                    </div>
                </div>
                <div class="col">
                    <div class="sp-pc-feature sp-pc-text-center">
                ...
                <div class="col">
                    <div class="sp-pc-feature sp-pc-text-center">
                        ...
                        <a href="https://github.com/ShapedPlugin/Post-Carousel" target="_blank" class="button button-primary">Report to GitHub</a>
                    </div>
                </div>
            </div>
