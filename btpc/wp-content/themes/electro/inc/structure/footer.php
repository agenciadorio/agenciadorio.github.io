	...
	function footer_newsletter_form() {
		...
		<form>
			<div class="input-group">
				<input type="text" class="form-control" placeholder="<?php echo esc_attr( __( 'Digite seu e-mail', 'electro' ) ); ?>">
				<span class="input-group-btn">
					<button class="btn btn-secondary" type="button"><?php echo esc_html( __( 'Cadastrar', 'electro' ) ); ?></button>
				</span>
			</div>
		</form>
		<?php
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="footer-contact col-xs-12 col-sm-12 col-md-5 col-md-pull-7">
						<h4 class="widget-title">FORMAS DE PAGAMENTO</h4><img class="alignnone size-medium wp-image-36" src="/wp-content/uploads/2017/10/forma-de-pagamento-pagseguro.png" alt="" width="300" height="114" />
					</div>
				</div>
				<?php else : ?>
					<?php electro_display_footer_bottom_widgets(); ?>
