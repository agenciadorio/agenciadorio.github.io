...
<div height="16" class="input-group-addon search-categories">
...
<?php
  ...
  <input type="image"  width="51" height="36" name="submit" src="https://www.bestpecas.com.br/wp-content/uploads/2018/04/bottom.png" border="0" alt="Submit" />		      
		</div>
	</div>
</form>
<?php else : ?>
