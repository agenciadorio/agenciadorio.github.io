				...
				<div class="column one">
					...
					<?php 
						if( $back_to_top_position == 'copyright' ){
							echo '<a href="http://www.agenciadorio.com.br"><img class="wp-image-2556 size-full alignright" src="/wp-content/uploads/2017/09/logoag-1.png" alt="" width="70" height="42" /></a>';
						}
					?>
