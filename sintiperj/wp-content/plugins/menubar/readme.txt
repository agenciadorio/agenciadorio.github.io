...
* Display a menu inserting in your theme, e.g. at the end of *header.php*, the following line:<br><code><?php do_action ('wp_menubar', 'name of your menu'); ?></code>

* Use the *Menubar* widget to display a menu in a widget ready area or sidebar

* Use the shortcode <code>[menubar menu='name of your menu']</code> to display a menu in a post or page, or in a Visual Composer text block
...
= 5.6 =
* Added shortcode to display a menu, in a page or Visual Composer text block
