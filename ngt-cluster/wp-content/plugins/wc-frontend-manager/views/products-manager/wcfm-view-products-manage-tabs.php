...
?>
			<?php if( apply_filters( 'wcfm_is_allow_inventory', true ) && apply_filters( 'wcfm_is_allow_pm_inventory', true ) ) { ?>
				...
				<?php if( apply_filters( 'wcfmu_is_allow_downloadable', true ) && apply_filters( 'wcfmu_is_allow_pm_downloadable', true ) ) { ?>
					<!-- collapsible 2 -->
					<div class="page_collapsible products_manage_downloadable simple downlodable non-variable-subscription non-redq_rental non-appointment" id="wcfm_products_manage_form_downloadable_head"><label class="fa fa-cloud-download"></label><?php _e('Downloadable', 'wc-frontend-manager-ultimate'); ?><span></span></div>
					<div class="wcfm-container simple downlodable non-variable-subscription non-redq_rental non-appointment">
						<div id="wcfm_products_manage_form_downloadable_expander" class="wcfm-content">
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_product_fields_downloadable', array(  
																																																	"downloadable_files" => array('label' => __('Files', 'wc-frontend-manager-ultimate') , 'type' => 'multiinput', 'class' => 'wcfm-text wcfm_ele simple downlodable', 'label_class' => 'wcfm_title', 'value' => $downloadable_files, 'options' => array(
																																																													"name" => array('label' => __('Name', 'wc-frontend-manager-ultimate'), 'type' => 'text', 'class' => 'wcfm-text wcfm_ele simple downlodable', 'label_class' => 'wcfm_ele wcfm_title simple downlodable', 'custom_attributes' => array( 'required' => 1 ) ),
																																																													"file" => array('label' => __('File', 'wc-frontend-manager-ultimate'), 'type' => 'upload', 'mime' => 'Uploads', 'class' => 'wcfm-text wcfm_ele simple downlodable downlodable_file', 'label_class' => 'wcfm_ele wcfm_title simple downlodable', 'custom_attributes' => array( 'required' => 1 ) ),
				...
				<!-- collapsible 5 -->
				<div class="page_collapsible products_manage_tax <?php echo apply_filters( 'wcfm_pm_block_class_tax', 'simple variable' ); ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_tax', '' ); ?>" id="wcfm_products_manage_form_tax_head"><label class="fa fa-money"></label><?php _e('Tax', 'wc-frontend-manager'); ?><span></span></div>
