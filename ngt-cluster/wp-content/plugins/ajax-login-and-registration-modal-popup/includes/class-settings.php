...
//            }
        ...
        $MESSAGES_SECTION->add_group( __( 'Login', 'ajax-login-and-registration-modal-popup' ), 'login' )
             ->add_field( array(
                 ...
                 'default'        => __('Entrar', 'ajax-login-and-registration-modal-popup'),
                 'render'      => array( new LRM_Field_Text(), 'input' ),
                 'sanitize'    => array( new LRM_Field_Text(), 'sanitize' ),
             ) )
             ->add_field( array(
                 ...
                 'default'        => __('          Email ou Usuario', 'ajax-login-and-registration-modal-popup'),
                 'render'      => array( new LRM_Field_Text(), 'input' ),
                 'sanitize'    => array( new LRM_Field_Text(), 'sanitize' ),
             ) )
             ->add_field( array(
                 ...
                 'default'        => __('          Senha', 'ajax-login-and-registration-modal-popup'),
                 'render'      => array( new LRM_Field_Text(), 'input' ),
                 'sanitize'    => array( new LRM_Field_Text(), 'sanitize' ),
             ) )
             ->add_field( array(
                 ...
                 'default'        => __('Manter-me conectado', 'ajax-login-and-registration-modal-popup'),
                 'render'      => array( new LRM_Field_Text(), 'input' ),
                 'sanitize'    => array( new LRM_Field_Text(), 'sanitize' ),
             ) )
             ->add_field( array(
             ...
             ->add_field( array(
                 ...
                 'default'        => __('Esqueci minha senha', 'ajax-login-and-registration-modal-popup'),
                 'render'      => array( new LRM_Field_Text(), 'input' ),
                 'sanitize'    => array( new LRM_Field_Text(), 'sanitize' ),
             ) )
            // == MESSAGES ==
        ...
        $MESSAGES_SECTION->add_group( __( 'Registration', 'ajax-login-and-registration-modal-popup' ), 'registration' )
             ->add_field( array(
                 'slug'        => 'heading',
                 'name'        => __('Form heading', 'ajax-login-and-registration-modal-popup' ),
                 'default'        => __('Nova conta', 'ajax-login-and-registration-modal-popup'),
                 'render'      => array( new LRM_Field_Text(), 'input' ),
                 'sanitize'    => array( new LRM_Field_Text(), 'sanitize' ),
             ) )
             ->add_field( array(
                 ...
                 'default'        => __('Usuario*', 'ajax-login-and-registration-modal-popup'),
                 'render'      => array( new LRM_Field_Text(), 'input' ),
                 'sanitize'    => array( new LRM_Field_Text(), 'sanitize' ),
             ) )
             ->add_field( array(
                 ...
                 'default'        => __('Nome*', 'ajax-login-and-registration-modal-popup'),
                 'render'      => array( new LRM_Field_Text(), 'input' ),
                 'sanitize'    => array( new LRM_Field_Text(), 'sanitize' ),
             ) )
             ->add_field( array(
                 ...
                 'default'        => __('Sobrenome', 'ajax-login-and-registration-modal-popup'),
                 'render'      => array( new LRM_Field_Text(), 'input' ),
                 'sanitize'    => array( new LRM_Field_Text(), 'sanitize' ),
             ) )
             ->add_field( array(
...
//            ) )
             ->add_field( array(
                 ...
                 'default'     => __('Eu concordo com os <a href=\'#0\'>Termos e condições</a>', 'ajax-login-and-registration-modal-popup'),
             ...
             ->add_field( array(
                 ...
                 'default'        => __('Criar conta', 'ajax-login-and-registration-modal-popup'),
                 'render'      => array( new LRM_Field_Text(), 'input' ),
                 'sanitize'    => array( new LRM_Field_Text(), 'sanitize' ),
             ) )
            // == MESSAGES ==
        ...
        $MESSAGES_SECTION->add_group( __( 'Lost password', 'ajax-login-and-registration-modal-popup' ), 'lost_password' )
             ->add_field( array(
                 ...
                 'default'        => __('Perdeu sua senha? Por favor, indique o seu endereço de e-mail. Você receberá um email com o link para definir a nova senha.', 'ajax-login-and-registration-modal-popup'),
                 'render'      => array( new LRM_Field_Text(), 'input' ),
                 'sanitize'    => array( new LRM_Field_Text(), 'sanitize' ),
             ) )
             ->add_field( array(
             ...
             ->add_field( array(
                 ...
                 'default'        => __('Redefinir senha', 'ajax-login-and-registration-modal-popup'),
                 'render'      => array( new LRM_Field_Text(), 'input' ),
                 'sanitize'    => array( new LRM_Field_Text(), 'sanitize' ),
             ) )
             ->add_field( array(
                 ...
                 'default'        => __('Voltar para o login', 'ajax-login-and-registration-modal-popup'),
                 'render'      => array( new LRM_Field_Text(), 'input' ),
                 'sanitize'    => array( new LRM_Field_Text(), 'sanitize' ),
             ) )
                // Errors!
