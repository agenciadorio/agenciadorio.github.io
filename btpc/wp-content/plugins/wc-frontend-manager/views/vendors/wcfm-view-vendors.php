					...
					<thead>
						<tr>
						  <th><span class="wcicon-status-processing text_tip" data-tip="<?php _e( 'Status', 'wc-frontend-manager' ); ?>"></span></th>
							...
							<?php } else { ?>
								<th><?php printf( apply_filters( 'wcfm_vednors_earned_commission_label', __( 'Total Earnings', 'wc-frontend-manager' ) ) ); ?></th>
								<th><?php printf( apply_filters( 'wcfm_vednors_received_commission_label', __( 'Total Withdrawal', 'wc-frontend-manager' ) ) ); ?></th>
							<?php } ?>
