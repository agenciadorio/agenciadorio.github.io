...
class WCFM_Capability {
  ...
  function wcfmcap_is_allow_product_limit( $allow ) {
  	...
  	$productlimit = apply_filters( 'wcfm_vendor_verification_product_limit', $productlimit );
  	$productlimit = apply_filters( 'wcfm_vendor_product_limit', $productlimit );
  ...
  function wcfmcap_is_allow_article_limit( $allow ) {
  	...
  	if( $articlelimit && ( $articlelimit >= 0 ) ) {
  		$current_user_id = apply_filters( 'wcfm_current_vendor_id', get_current_user_id() );
			$count_articles  = wcfm_get_user_posts_count( $current_user_id, 'post', 'any' );
