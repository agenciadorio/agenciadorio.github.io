            ...
            if (position == 'left' || position == "right") {
                ...
                if (!keepSize) {
                    ...
                    var _loop_2 = function (iteration) {
                        ...
                        field.JQueryElement.velocity({ width: containerWidth * field.Options.ContainerOptions.Width / 100 }, SmartFormsModules.animationSpeed, "easeOutExp", function (element) {
                ...
                $jQueryToInsert_1.velocity({ width: containerWidth * fieldToInsert.Options.ContainerOptions.Width / 100 }, SmartFormsModules.animationSpeed, "easeOutExp", function (element) {
