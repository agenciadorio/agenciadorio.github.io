...
<div id="reviews" class="electro-advanced-reviews">
	<div class="advanced-review row">
		<div class="col-xs-12 col-md-6">
			<h2 class="based-title"><?php echo esc_html( sprintf( _n( 'Baseado em %s avaliação', 'Baseado em %s avaliações', $review_count, 'electro' ), $review_count ) ); ?></h2>
			<div class="avg-rating">
				<?php 
					$avg_rating_html = '<span class="avg-rating-number">' . $avg_rating_number . '</span>';
					echo wp_kses_post( sprintf( __( '%s no geral', 'electro' ), $avg_rating_html ) ); ?>
			</div>
			...
			<div id="review_form_wrapper">
				<div id="review_form">
					<?php
						...
						$comment_form = array(
							'title_reply'          => have_comments() ? __( 'Add a review', 'electro' ) : sprintf( __( 'Deixe sua avaliação sobre &ldquo;%s&rdquo;', 'electro' ), get_the_title() ),
							...
							'label_submit'  => __( 'Adicionar', 'electro' ),
							'logged_in_as'  => '',
							'comment_field' => ''
						);
						...
						if ( get_option( 'woocommerce_enable_review_rating' ) === 'yes' ) {
							$comment_form['comment_field'] = '<p class="comment-form-rating"><label for="rating">' . __( 'Sua nota', 'electro' ) .'</label><select name="rating" id="rating">
						...
						$comment_form['comment_field'] .= '<p class="comment-form-comment"><label for="comment">' . __( 'Comentário', 'electro' ) . '</label><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea></p>';
	...
	<div id="comments">
		...
		<?php else : ?>
			...
			<p class="woocommerce-noreviews"><?php _e( 'Não existem comentários ainda. Seja o primeiro a avaliar este produto!', 'electro' ); ?></p>
