...
if( class_exists( 'WP_Widget' ) ) :
	...
	class Electro_Product_Categories_Widget extends WP_Widget {
		...
		public function __construct() {
			$widget_ops = array( 'classname' => 'woocommerce-info2 widget_product_categories ', 'description' => esc_html__( 'A list of product categories.', 'electro' ) );
		...
		public function widget($args, $instance) {
			...
			if ( $this->current_cat ) {
				...
				$show_all_categories_text = apply_filters( 'electro_product_categories_widget_show_all_categories_text', esc_html__( 'Todas as categorias', 'electro' ) );
