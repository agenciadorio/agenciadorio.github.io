...
if ( ! function_exists( 'electro_shipping_details_header' ) ) {
	...
	function electro_shipping_details_header() {
		...
		<h3><?php echo esc_html__( 'Detalhes de Entrega', 'electro' ); ?></h3>
		<?php endif;
	}
}
...
if ( ! function_exists( 'electro_before_login_text' ) ) {
	...
	function electro_before_login_text() {
		...
		<p class="before-login-text">
			<?php echo apply_filters( 'electro_before_login_text', esc_html__( 'Bem vindo! Faça login na sua conta. ', 'electro' ) ); ?>
		</p>
		<?php
	}
}
...
if ( ! function_exists( 'electro_before_register_text' ) ) {
	...
	function electro_before_register_text() {
		...
		<p class="before-register-text">
			<?php echo apply_filters( 'electro_before_register_text', esc_html__( 'Cria uma conta. É rápido e grátis!', 'electro' ) ); ?>
		</p>
		<?php
	}
}
...
if ( ! function_exists( 'electro_register_benefits' ) ) {
	...
	function electro_register_benefits() {
		$benefits = apply_filters( 'electro_register_benefits', array(
			esc_html__( 'Checkout rápido e transparente', 'electro' ),
			esc_html__( 'Melhor monitoramento de pedidos', 'electro' ),
			esc_html__( 'Descontos e promoções', 'electro' )
		) );

		?>
		<div class="register-benefits">
			<h3><?php echo apply_filters( 'electro_register_benefits_title', esc_html__( 'Vantagens' , 'electro' ) ); ?></h3>
			<ul>
...
if ( ! function_exists( 'electro_wrap_customer_login_form' ) ) {
	...
	function electro_wrap_customer_login_form() {
		...
		$or_text = '<span class="or-text">' . apply_filters( 'electro_or_text', esc_html__( 'ou', 'electro' ) ) . '</span>';
...
if ( ! function_exists( 'electro_wrap_order_review' ) ) {
	function electro_wrap_order_review() {
		?><div class="order-review-wrapper">
			<h3 id="order_review_heading_v2"><?php _e( 'Seu pedido', 'electro' ); ?></h3><?php
	}
}
