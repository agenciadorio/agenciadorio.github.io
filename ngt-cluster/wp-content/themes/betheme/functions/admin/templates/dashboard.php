	...
	<div class="dashboard-tab register">
		...
		<div class="col col-left">
			...
			<?php if( mfn_is_registered() ): ?>
				...
				<?php if( ! WHITE_LABEL ): ?>
					...
					<a class="mfn-button mfn-button-secondary" target="_blank" href="https://themeforest.net/item/betheme-responsive-multipurpose-wordpress-theme/7758048?ref=muffingroup&license=regular&open_purchase_for_item_id=7758048"><?php esc_html_e( 'Purchase new license', 'mfn-opts' ); ?></a>
		...
		<div class="col col-right">
			...
			<ul class="links">
				...
				<li><a href="themes.php?page=muffin_options"><?php esc_html_e( 'Theme Options', 'mfn-opts' ); ?></a></li>
