<?php  
   ...
   add_action( 'vc_before_init', 'qt_vc_gridstack_owl_row' );
   if(!function_exists('qt_vc_gridstack_owl_row')){
   function qt_vc_gridstack_owl_row() {
      vc_map( array(
         "name" => __( "Gridstack Owl Carowsel Row", "qt-extensions-suite" ),
         "base" => "qt-owlcarousel-row",
         ...
         ,array(
          ...
          ,array(
               "type" => "checkbox",
               "heading" => __( "Read more link", "qt-extensions-suite" ),
               "param_name" => "readmore"
            )
