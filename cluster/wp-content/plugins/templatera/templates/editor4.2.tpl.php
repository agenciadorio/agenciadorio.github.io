<div id="vc-templatera-editor" class="vc_panel vc_templates-editor" style="display: none;">
	...
	<div class="vc_panel-body wpb-edit-form vc_templates-body vc_properties-list vc_with-tabs">
		<div class="vc_row wpb_edit_form_elements">
			<div class="vc_column">
				<div id="vc_tabs-templatera" class="vc_panel-tabs">
					<?php $templates = apply_filters( 'vc_load_default_templates_templatera', visual_composer()->templatesEditor()->loadDefaultTemplates() );  $templates_exists = is_array( $templates ) && !empty( $templates ); ?>
					<ul class="vc_edit-form-tabs-menu">
						<li class="vc_edit-form-tab-control"><a class="vc_edit-form-link" href="#tabs-templatera-tabs-1"><?php _e('My templates','js_composer'); ?></a></li>
						<?php if( $templates_exists ): ?>
						<li class="vc_edit-form-tab-control"><a class="vc_edit-form-link" href="#tabs-templatera-tabs-2"><?php _e('Default templates','js_composer'); ?></a></li>
						<?php endif; ?>
					</ul>
					<div id="tabs-templatera-tabs-1" class="vc_edit-form-tab">
					...
					<?php if( $templates_exists ): ?>
					<div id="tabs-templatera-tabs-2" class="vc_edit-form-tab">
						<div class="vc_col-md-12 vc_column inside">
