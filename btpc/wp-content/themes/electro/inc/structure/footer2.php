...
if ( ! function_exists( 'electro_footer_widgets' ) ) {
	...
	function electro_footer_widgets() {
		if( apply_filters( 'electro_footer_widgets', false  ) ) {
			?>
	...
	function footer_newsletter_form() {
		...
		<form>
			...
			<div class="input-group">
				<input type="text" class="form-control2" size="35" placeholder="<?php echo esc_attr( __( 'Digite seu e-mail', 'electro' ) ); ?>">
				<span class="input-group-btn">
					<input type="submit" id="es_txt_button" class="es_textbox_button es_submit_button" name="es_txt_button" value="CADASTRAR">
				</span>
			</div>
		</form>
		<?php
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="footer-contact col-xs-12 col-sm-12 col-md-5 col-md-pull-7">
						<h4 class="widget-title">FORMAS DE PAGAMENTO</h4><img class="alignnone size-medium wp-image-36" src="/wp-content/uploads/2018/03/pagamento.png" alt="" width="209" height="146"  />
					</div>
				</div>
				<?php else : ?>
					<?php electro_display_footer_bottom_widgets(); ?>
...
if ( ! function_exists( 'electro_copyright_bar' ) ) {
	...
	function electro_copyright_bar() {
		...
		<div class="copyright-bar">
			<div class="container">
				<div class="pull-left flip copyright"><?php echo wp_kses_post( $footer_copyright_text ); ?> <br/>  </div>
				<div class="pull-right flip payment"><a href="http://www.agenciadorio.com.br" target="_blank"><img class="alignright wp-image-4772 size-full" src="/wp-content/uploads/2017/03/logomarc.png" width="90" height="35" /></a></div>
			</div> <br/> <center> <small> É vetada a reprodução total ou parcial das informações aqui veiculadas sem a expressa autorização da administração do site. <br/> Os preços e condições de pagamento são válidos exclusivamente para compras realizadas via internet e poderão sofrer alteração sem aviso prévio. Em caso de divergência, o preço válido é sempre o do carrinho de compras. </small>
		</div><?php
