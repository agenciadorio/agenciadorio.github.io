...
if ( ! function_exists( 'electro_default_wc_footer_widgets' ) ) {
	...
	function electro_default_wc_footer_widgets( $args ) {
		...
		if( class_exists( 'WC_Widget_Products' ) ) {
			...
			the_widget( 'WC_Widget_Products', array( 'title' => __( 'Produtos em destaque', 'electro' ), 'show' => 'featured', 'number' => '2', 'orderby' => 'DESC', 'order' => 'date', 'id' => 'featured-products-footer' ), $args );

			$args['widget_id'] = 'onsale-products-footer';
			the_widget( 'WC_Widget_Products', array( 'title' => __( 'Sugestoes', 'electro' ), 'show' => 'onsale', 'number' => '2', 'orderby' => 'DESC', 'order' => 'date', 'id' => 'onsale-products-footer' ), $args );
		}

		if( class_exists( 'WC_Widget_Top_Rated_Products' ) ) {	
			$args['widget_id'] = 'top-rated-products-footer';
			the_widget( 'WC_Widget_Top_Rated_Products', array( 'title' => __( 'Mais votados', 'electro' ), 'number' => '2', 'id' => 'top-rated-products-footer' ), $args );
		}
