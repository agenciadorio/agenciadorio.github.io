			...
			<div class="wcfm-tabWrap">
			  <!-- collapsible - Store -->
								...
								<div class="store_address">
									<?php
										$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_wcmarketplace_settings_fields_address', array(
																																																			...
																																																			"addr_2" => array('label' => __('Bairro', 'wc-frontend-manager') , 'type' => 'text', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'value' => $addr_2 ),
							...
							<div id="wcfm_settings_form_shipping_expander" class="wcfm-content">
								<?php
									...
									if( !$has_shipping_settings_option ) {
										_e( 'Não é possivel alterar as opções de frete. Pois as formas de envio já foram pré definidas pelo administrador.', 'wc-frontend-manager' );
									}
								?>
							</div>
						</div>
						...
						<div id="wcfm_settings_form_policies_expander" class="wcfm-content">
							<?php
								...
								if ( $can_vendor_edit_refund_policy_field ) {
									$vendor_refund_policy = get_user_meta( $user_id, '_vendor_refund_policy', true ); 
							  ...
							  <?php
							    $vendor_customer_phone = get_user_meta( $user_id, '_vendor_customer_phone', true );
									...
									$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_wcmarketplace_settings_fields_customer_support', array(
																																																		...
																																																		"vendor_csd_return_address2" => array('label' => __('Bairro', 'wc-frontend-manager') , 'type' => 'text', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'value' => $vendor_csd_return_address2 ),
				...
				<?php if( WCFM_Dependencies::wcfmu_plugin_active_check() ) { ?>
					<?php if( apply_filters( 'wcfm_is_allow_vacation_settings', true ) ) { ?>
