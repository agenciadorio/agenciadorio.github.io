...
function wpaft_carousel_taxonomy() {
	register_taxonomy(
		'carousel_cat',  
		'client-logo',                  
		array(
...
add_action( 'init', 'wpaft_carousel_taxonomy'); 
 ...
 */
	...
	<div id="wpaft-logo-slider-<?php echo $add_id;?>" class="owl-carousel">
	<?php while ( $query->have_posts() ) : $query->the_post(); ?>
	
	<div class="logo-container">
	<?php if(get_post_meta(get_the_ID(),'wpaft_clientlogo_meta_url',true) != ''){
	 ?>
