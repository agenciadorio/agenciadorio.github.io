						...
						<div id="wcfm_products_manage_form_downloadable_expander" class="wcfm-content">
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_product_fields_downloadable', array(  
																																																	"downloadable_files" => array('label' => __('Files', 'wc-frontend-manager-ultimate') , 'type' => 'multiinput', 'class' => 'wcfm-text wcfm_ele simple downlodable', 'label_class' => 'wcfm_title', 'value' => $downloadable_files, 'options' => array(
																																																													...
																																																													"file" => array('label' => __('File', 'wc-frontend-manager-ultimate'), 'type' => 'upload', 'mime' => 'Uploads', 'class' => 'wcfm-text wcfm_ele simple downlodable downlodable_file', 'label_class' => 'wcfm_ele wcfm_title simple downlodable', 'custom_attributes' => array( 'required' => 1, 'required_message' => __( 'Downloadable file is required.', 'wc-frontend-manager-ultimate' ) ) ),
				...
				<!-- collapsible 5 -->
				<div class="page_collapsible products_manage_tax <?php echo apply_filters( 'wcfm_pm_block_class_tax', 'simple variable' ); ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_tax', '' ); ?>" id="wcfm_products_manage_form_tax_head"><label class="fa fa-paypal"></label><?php _e('Tax', 'wc-frontend-manager'); ?><span></span></div>
