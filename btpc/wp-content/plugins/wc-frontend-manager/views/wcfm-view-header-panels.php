...
<div class="wcfm_header_panel">
  ...
  <a href="/dashboard/lojista/" target="_blank">Área do Lojista (Extranet)
  ...
  <?php if( apply_filters( 'wcfm_is_pref_knowledgebase', true ) && apply_filters( 'wcfm_is_allow_knowledgebase', true ) ) { ?>
    <a href="<?php echo get_wcfm_knowledgebase_url(); ?>" class="wcfm_header_panel_knowledgebase text_tip <?php if( isset( $wp->query_vars['wcfm-knowledgebase'] ) || isset( $wp->query_vars['wcfm-knowledgebase-manage'] ) ) echo 'active'; ?>" data-tip="<?php _e( 'Principais dúvidas', 'wc-frontend-manager' ); ?>"><i class="fa fa-book"></i></a>
  <?php } ?>
