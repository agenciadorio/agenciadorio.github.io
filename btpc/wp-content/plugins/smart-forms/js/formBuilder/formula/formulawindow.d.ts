...
declare class RedNaoFormulaWindow {
    ...
    private GetLabel(label, id);
    private CreateFieldTag(label, id);
    private CodeMirrorChange(instance, object);
    private SetCodeMirror(text);
    private ExecuteSearch();
    private EncodeFields(text);
    private DecodeFields(text);
    private ProcessRemoteCalls(formula);
}
