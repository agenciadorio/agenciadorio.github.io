...
add_action( 'tgmpa_register', 'finance_register_required_plugins' );
 ...
 */
function finance_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'     				=> esc_html__( 'Contact Form 7', 'finance' ), // The plugin name
		...
		array(
			'name'     				=> esc_html__( 'ACF Pro', 'finance' ), // The plugin name
		...
		array(
			'name'     				=> esc_html__( 'Finance Extra', 'finance' ), // The plugin name
			'slug'     				=> 'finance-extra', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory() . '/plugins/finance-extra.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
			'version' 				=> '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
		...
		array(
			'name'     				=> esc_html__( 'MailChimp for WordPress', 'finance' ), // The plugin name
		...
		array(
			'name'     				=> esc_html__( 'Redux Framework', 'finance' ), // The plugin name
		...
		array(
			'name'     				=> esc_html__( 'Revolution Slider', 'finance' ), // The plugin name
