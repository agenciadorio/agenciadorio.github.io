...
$addNewDependencies= array('smart-forms-add-new-tutorial','smart-forms-list-manager','ismart-forms-add-new','isolated-slider','smart-forms-formula-window','smart-forms-formBuilder','smart-forms-select2','smart-forms-event-manager','smart-forms-conditional-manager','smart-forms-systemjs-main-config');
...
wp_enqueue_script('smart-forms-add-new',SMART_FORMS_DIR_URL.'js/main_screens/smart-forms-add-new-loader.js',$addNewDependencies,SMART_FORMS_FILE_VERSION);
...
<script type="text/javascript">
    ...
    var SmartFormsEnableGDPR="<?php echo $GDPR?>";
    var smartFormsShowTutorial='<?php echo get_option('smart_forms_show_tutorial')?>';
    ...
    var smartFormsPreviewUrl='<?php echo trim(site_url())?>?smartformspreview=1';
...
<div style="position: relative;" id="sfMainContainer">
    <div id="loadingScreen" style="background-color: white;width: 100%;height: 100%;top:0;left:0;z-index: 100000; position: absolute;text-align: center;">
        <div style="top:200px;position: absolute;width: 100%;text-align: center;" id="smartFormsLoadingLogo">
            <img  src="<?php echo SMART_FORMS_DIR_URL?>images/ProgressBar2.gif" height="211;" alt="" />
    ...
    <div id="rootContentDiv" class="OpHidden">
        <?php
        ...
        <h2 class="nav-tab-wrapper" id="smartFormsTopTab">
            ...
            <?php
                ...
                {
                    wp_enqueue_script('smart-forms-donation-elements',SMART_FORMS_DIR_URL.'js/integration/smart-donations-integration.js',array('smart-forms-form-elements','smart-forms-add-new'),SMART_FORMS_FILE_VERSION);
                    ?>
        ...
        <div class="bootstrap-wrapper">
            <table id="smartFormsAfterSubmitDiv" style="display: none;border:none;width:auto;" class="table table-bordered table-striped">
                <thead>
                    <tr>
                           ...
                           <div id="formSettingsScrollArea">
                               <div id="formSettings" >
                                   <ul class="nav nav-tabs" id="sfSettingTabs" role="tablist" style="margin: 0">
                                       <li   class="active"><a style="cursor:pointer"  id="formRadio1" href="#formBuilderComponents" data-toggle="tab"><span class="glyphicon glyphicon-list-alt"></span><?php echo __("Fields")?></a></li>
                                       <li   ><a style="cursor:pointer" id="formRadio2" href="#formPropertiesContainer" data-toggle="tab"><span class="glyphicon glyphicon glyphicon-cog"></span><?php echo __("Field Settings")?></a></li>
                                       <li   ><a style="cursor:pointer" id="formRadio4" href="#formStylesContainer" data-toggle="tab"><span class="fa fa-paint-brush"></span><?php echo __("Styles")?></a></li>
                                       <li ><a style="cursor:pointer" id="formRadio3" href="#formConditionalLogicContainer" data-toggle="tab"><span class="glyphicon glyphicon glyphicon-link"></span><?php echo __("Conditional Logic")?></a></li>
                                   </ul>
                                   <!--
                                        ...
                                        <div class="span6 tab-pane active" id="formBuilderComponents">
                                            ...
                                            <div class="tabbable" >
                                                <ul class="nav nav-tabs" id="navtab">
                                                    ...
                                                    <li><a id="atabsurvey" class="formtab"><?php echo __("Others")?></a></li>
                                                ...
                                                <div class="form-horizontal" id="components">
                                                    <fieldset  >
                                                        <div class="tab-content">
                                                            <div class="tab-pane active rednaotablist smartFormFieldTabLayout" id="layout" style="display: none;width:100%;">
                                                                <div class="component">
                                                            ...
                                                            <div class="tab-pane active rednaotablist smartFormFieldTabBasic" id="tabinput">
                                                                <div class="component">
                                                            ...
                                                            <div class="tab-pane rednaotablist smartFormFieldTabAdvanced" id="tabselect"  style="display: none;">
                                                                <div class="component">
                                                            ...
                                                            <div class="tab-pane rednaotablist smartFormFieldTabMultiple" id="tabradioscheckboxes" style="display: none;">
                                                                <div class="component">
                                                            ...
                                                            <div class="tab-pane rednaotablist smartFormFieldTabOthers" id="tabsurvey" style="display: none;">
                                                                <div class="component">
                                ...
                                <td style="vertical-align: top;background-color: white" class="smartFormsSelectedElementContainer">
                                    ...
                                    <div class="span6 " id="newFormContainer" style="margin:0;padding-right: 10px;cursor: e-resize;">
                                        <div class="clearfix" style="text-align:left;background-color: white;cursor: auto;">


                                            <div id="build">
                                                <div id="target" class="form-horizontal" style="background-color:white;">
                                                    <div id="redNaoElementlist" class="formelements bootstrap-wrapper SfFormElementContainer" >
