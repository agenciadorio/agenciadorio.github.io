    ...
    multi_input_holder.children('.multi_input_block').each(function() {
      ...
      if( multi_input_limit != 1 ) {
      	if( !multi_input_holder.hasClass( 'wcfm_non_sortable' ) ) {
      		$(this).prepend('<span class="fa fa-arrows-alt wcfm_multiblock_sortable" title="'+wcfm_dashboard_messages.wcfm_multiblick_sortable_help+'"></span><div class="wcfm_clearfix"></div>');
      	}
      }
    });
