				...
				<div class="wcfm_dashboard_stats_block">
				  <a href="#" onclick="return false;">
						...
						<div>
							<strong>
								<?php
								echo apply_filters( 'wcfm_customers_money_spent_data', wc_price( wc_get_customer_total_spent( $customer_id ) ), $customer_id );
								?>
							</strong><br />
				...
				<div class="wcfm_dashboard_stats_block">
				  <a href="#" onclick="return false;">
						...
						<div>
							...
							$total_order = apply_filters( 'wcfm_customers_total_orders_data', $total_order, $customer_id );
